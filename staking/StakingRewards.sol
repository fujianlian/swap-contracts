...
//    IERC20 public rewardsToken;
    ...
    function rewardPerToken() public view returns (uint256) {
        ...
        rewardPerTokenStored.add(
            lastTimeRewardApplicable().sub(lastUpdateTime).mul(rewardRate).div(_totalSupply)
        );
    }
...
//            rewardsToken.safeTransfer(msg.sender, reward);
     ...
     * @dev 给奖励池添加金额
     */
    function notifyRewardAmount() external payable onlyRewardsDistribution updateReward(address(uint160(0))) {
...
//        require(rewardRate <= balance.div(rewardsDuration), "Provided reward too high");
        require(rewardRate <= totalRewards.div(rewardsDuration), "Provided reward too high");
